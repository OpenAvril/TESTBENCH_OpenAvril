...
int main()
{
    ...
    OpenAvrilLIB::WriteEnableForThreadsAt_STACK_Framework* pgmID_WR = (OpenAvrilLIB::WriteEnableForThreadsAt_STACK_Framework*)OpenAvrilLIB::CLIDWriteEnableForThreadsAtSTACK::create_Program();
    while(pgmID_WR == NULL) { }
    //pgmID_WR->initialise(pgmID_WR);
