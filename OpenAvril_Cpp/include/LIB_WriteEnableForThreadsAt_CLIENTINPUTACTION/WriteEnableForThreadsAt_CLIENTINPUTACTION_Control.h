...
namespace OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION
{
    ...
    public:
        ...
        ~WriteEnableForThreadsAt_CLIENTINPUTACTION_Control();
        static void boot0_CLASS_DECLAIRE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control();
        static void boot1_CLASS_DEFINE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control();
        static void boot3_CLASS_INITIALISE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control();
        static void boot0_REG_DECLAIRE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control();
        void boot1_REG_DEFINE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj);
        void boot2_REG_SUBSTANTIATE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj);
        void boot3_REG_INITIALISE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj);
        void boot4_PGM_INSTANTIATE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Control(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj);
        void app_FUNCT_writeEnable_Activate(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj, uint8_t coreId);
        void app_FUNCT_writeEnable_SortQue(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj);
        void app_FUNCT_writeEnable_Request(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj, uint8_t coreId);
        void app_FUNCT_writeQue_Update(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj);
        ...
        static void stat_REG_boot2_SUBSTANTIATE_WriteACTIVE_Count_For_ThreadId(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj);
        static void stat_REG_boot2_SUBSTANTIATE_WriteIDLE_Count_For_ThreadId(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj);
        static void stat_REG_boot2_SUBSTANTIATE_WriteWAIT_Count_For_ThreadId(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj);
