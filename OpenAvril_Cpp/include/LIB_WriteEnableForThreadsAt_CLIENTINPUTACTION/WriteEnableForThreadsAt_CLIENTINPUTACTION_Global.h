...
namespace OpenAvrilCLIBWriteEnableForThreadsAtCLIENTINPUTACTION
{
    ...
    public:
        ...
        ~WriteEnableForThreadsAt_CLIENTINPUTACTION_Global();
        static void boot0_CLASS_DECLAIRE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Global();
        static void boot1_CLASS_DEFINE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Global();
        static void boot3_CLASS_INITIALISE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Global();
        static void boot0_REG_DECLAIRE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Global();
        void boot1_REG_DEFINE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Global(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj);
        void boot2_REG_SUBSTANTIATE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Global(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj);
        void boot3_REG_INITIALISE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Global(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj);
        void boot4_PGM_INSTANTIATE_WriteEnableForThreadsAt_CLIENTINPUTACTION_Global(class WriteEnableForThreadsAt_CLIENTINPUTACTION_Framework* obj);
