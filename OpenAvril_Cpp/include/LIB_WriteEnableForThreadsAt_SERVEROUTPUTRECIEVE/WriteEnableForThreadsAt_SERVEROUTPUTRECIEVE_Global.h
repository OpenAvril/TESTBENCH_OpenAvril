...
namespace OpenAvrilCLIBWriteEnableForThreadsAtSERVEROUTPUTRECIEVE
{
    ...
    public:
        ...
        ~WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Global();
        static void boot0_CLASS_DECLAIRE_WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Global();
        static void boot1_CLASS_DEFINE_WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Global();
        ...
        void boot1_REG_DEFINE_WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Global(class WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj);
        void boot2_REG_SUBSTANTIATE_WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Global(class WriteEnableForThreadsAt_SERVEROUTPUTRECIEVE_Framework* obj);
